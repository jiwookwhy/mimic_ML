...
def generateTables(save=True, savepath='../processed_data/allTables_04172022.pkl'):
    ...
    print('# Unique icu stays:{} | # Unique hadms: {}'.format(len(cohort_stays), len(cohort_hadms)))
...
def loadTables(filepath='../processed_data/allTables_04172022.pkl'):
...
def main(hadms=None):
    ...
    generateTables(save=True)
    tables='../processed_data/allTables_04172022.pkl'
    ...
    if hadms==None:
        ...
        outputname = "../processed_data/processedFrames_04172022.pkl"
    else:
        outputname = "../processed_data/h_frames/set-" + str(hadms[0]) +".pkl"

    outputFrames = {}
    outputFrames = Parallel(n_jobs=15, verbose=50)(delayed(produceFrames)(outputFrames, h, adms_df[adms_df.hadm == h],
    ...
    print('Total hadms in original frames: {}'.format(len(outputFrames)))
    print('Total hadms in filtered frames:{}'.format(len(list(filteredOutputFrames.keys()))))
